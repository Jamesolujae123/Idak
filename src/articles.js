...
<div className='featured-a'>
    ...
    <p>February 4, 2023</p>
    <h4>Plan the Perfect Vacation</h4>
    <p>Discover expert advice on how to find the ideal rental property that meets your needs and budget.</p></div>

   
<div className='right-a'> <div className='mid-art'><img className='art2' src={art2} art="art2" /> 
<div className='mid-art-abt'><p>May 7, 2023</p>
<h4>Car Rental hacks for smooth Journey</h4>
<p>Learn insider tips for getting the best deals and making the most of your rental car experience.</p></div>

</div>
<div className='mid-art'><img className='art3' src={art3} alt="art3" />
<div className='mid-art-abt'><p>May 7, 2023</p>
<h4>Car Rental hacks for smooth Journey</h4>
<p>Learn insider tips for getting the best deals and making the most of your rental car experience.</p></div></div>
